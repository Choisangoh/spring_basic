...
<body>
	...
	<div class="row box-box-success">
		...
		<div class="box-body">
			<strong>글쓴이</strong>
			<input type="text" id="newReplyWriter" placeholder="글쓴이 작성" class="form-control">
			<strong>댓글</strong>
			<input type="text" id="newReplyText" placeholder="댓글 내용" class="form-control">
		</div><!-- body -->
		<div class="box-footer">
			<button class="btn btn-success" id="replyAddBtn">댓글 추가</button>
		</div><!-- footer -->
	</div><!-- row -->
	...
	<script>
		...
		$("#replies").on("click", ".replyLi button", function(){
			...
			// (힌트는 .siblings("요소명"); 으로 형제태그를 가져올 수 있다.)
			var replyContent = $(this).prev().text(); // button의 직전 태그인 .reply 내용 가져오기
			var replyContent = $(this).siblings(".reply").text(); // bbutton의 형제 중 .reply 내용 가져오기
